...
type TSPolicy <: TreePolicy
    ...
    function TSPolicy(pm::MDP, feasible_actions::Dict{Action, Bool})
...
function updatePolicy(policy::TSPolicy, pm::MDP, a::Action, q::Float64)
...
function updatePolicy(policy::TSMPolicy, pm::MDP, a::Action, q::Float64)
    ...
    function AUCBPolicy(pm::MDP, feasible_actions::Dict{Action, Bool}, subpolicies::Vector{Dict{ASCIIString, Any}}; control_policy::Dict{ASCIIString, Any} = Dict("type" => :TSN), bScale::Bool = false)
        ...
        for subpolicy in subpolicies
            ...
            elseif subpolicy["type"] == :TSM
                self.subpolicies[i] = TSMPolicy(pm, feasible_actions, subpolicy["ARM"])
